...
extern _remove_leading_zeroes
extern _subtract_whole

section .text
global _divide_whole
_divide_whole:
  ; Input:
...
_divide_whole_loop_2:
  ...
  cmp    r10, r11
  jg     _divide_whole_loop_2
  lea    r10, [rcx * 5]
  add    r10, r11
  mov    byte [r8 + r10], 48
_after_divide_whole_if_1:
  xor    r10, r10
_divide_whole_loop_3:
  mov    byte [r8 + r10], 0
  ...
  lea    r12, [rbx + 2]
  cmp    r10, r12
  js     _divide_whole_loop_3
  inc    r9
  cmp    r9, 10
  js     _divide_whole_loop_1
  mov   r9b, byte [rdi]
  lea   r10, [rcx * 3]
  add   r10, r8
  mov   byte [r10], r9b
  mov   byte [r10 + 1], 0
  xor   r11, r11
_divide_whole_loop_4:
  xor   r9, r9
  mov   byte [r8 + r15 + 2], r9b
_divide_whole_loop_5:
  xor   r10, r10
_divide_whole_loop_6:
  lea   r12, [rcx * 2]
  add   r12, r10
  mov   byte [r8 + r12], 0
  inc   r10
...
_divide_whole_loop_7:
  ...
  mov   byte [r8 + r15 + 2], r9b
  xor   r10, r10
_divide_whole_loop_8:
  mov   byte [r8 + r10], 0
  inc   r10
  lea   r12, [rbx + 2]
  cmp   r10, r12
  js    _divide_whole_loop_8
  push  rax
  push  rdi
  push  rcx
  lea   rdi, [rcx * 5]
...
_divide_whole_loop_9:
  ...
  inc   r10
  cmp   r10, r12
  js    _divide_whole_loop_9
  inc   r9
  cmp   r9, 10
  js    _divide_whole_loop_5
_after_divide_whole_loop_5:
  xor   r10, r10
_divide_whole_loop_10:
  lea   r12, [rcx * 2]
  add   r12, r10
  mov   byte [r8 + r12], 0
  inc   r10
